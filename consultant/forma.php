...
header("Content-Type: text/html; charset=UTF-8"); ?>
		...
		jQuery('#ok_submit').click(function(){
          ...
          if(jQuery.trim(jQuery("#consult_text").val()) == '' || jQuery("#consult_text").val() == "Текст вашего сообщения"){
			...
			jQuery('#consult_mess').css('display', 'block');
				jQuery.ajax({
					type: "post",
					url: "https://spravka.000webhostapp.com/consultant/class/processing_form.php",
    ...
    .nocons{
		...
		width: 100%;
		height: 355px;
		background: url('https://spravka.000webhostapp.com/consultant/images/form_background.png') #777 repeat;
        color: #000;
	...
	#ok_form_img{
		...
		background: url('https://spravka.000webhostapp.com/consultant/images/form_cons_img.png') no-repeat;
	...
	.img_class{
	    ...
	    background: url('https://spravka.000webhostapp.com/consultant/images/gradient-form.png') 0 0 repeat-x;
	}
    .img_class img{
    	border: none;
    	margin-left: 2px;
...
<div id="pad">
	...
	<div id="ok_forma">
		...
		<div class="ok_field"><input id="consult_mail" type="text" name="sendform_mail" value="Ваш E-Mail" /><span class="img_class" id="ok_email"><img src="https://spravka.000webhostapp.com/consultant/images/web.png" /></span></div>
		
		<div class="ok_field"><input id="consult_name" type="text" name="sendform_name" value="Ваше имя" /><span class="img_class" id="ok_name"><img src="https://spravka.000webhostapp.com/consultant/images/user.png" /></span></div>
	   
		<div class="ok_field"><input id="consult_tel" type="text" name="sendform_tell" value="Ваш телефон" /><span class="img_class" id="ok_tel"><img src="https://spravka.000webhostapp.com/consultant/images/mobile.png" /></span></div>
