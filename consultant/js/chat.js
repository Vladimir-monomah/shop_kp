...
jQuery('#ok_load_file').click(function(){
            ...
            script_tag.setAttribute("src","https://spravka.000webhostapp.com/consultant/js/ajaxupload.js");
	...
	var button = jQuery('#uploadButton'), interval;
      ...
      jQuery.ajax_upload(button, {
            ...
            onSubmit : function(file, ext) {
              ...
              jQuery("img#load").attr("src", "https://spravka.000webhostapp.com/consultant/images/ajax-loader.gif");
...
function getNewMess(){
    ...
    jQuery.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/class/get_user_new_mess.php',
            type: 'POST',
			cache: false,
			timeout: 70000,
            error: function(){
...
function connection(){
    ...
    if(jQuery.cookie("operator_id")){
        ...
        jQuery.ajax({
                url: 'https://spravka.000webhostapp.com/consultant/class/connection_operator.php',
                type: 'POST',
                ...
                success: function(operator){
                    if(operator){
                        ...
                        if(operator.online){
                            ...
                            jQuery('#iframe').load("https://spravka.000webhostapp.com/consultant/forma.php");
...
function getMessList(){
    jQuery.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/class/get_mess_list.php',
            type: 'POST',
            cache: false,
            error: function(){
...
function viewOperatorInfo(){
    ...
    jQuery('#avatar_olya img').attr('src', 'https://spravka.000webhostapp.com/consultant/images/operator/'+jQuery.cookie('operator_photo'));
...
function voting(vot){
    ...
    if(jQuery.cookie('ok_user_id') !== undefined){
        ...
        jQuery.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/class/voting.php',
            type: 'POST',
            data: {vot: vot},
            cache: false,
...
function sendmess(){
    ...
    jQuery.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/class/add_user_mess.php',
            type: 'POST',
...
function sendMessEmail(){
	...
	if(validEmail(ok_email)){ // Send...
		...
		jQuery.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/send_mess_email.php',
                    type: 'POST',
