...
$('.user_dialog').live('click', function(){
	var user_id = $(this).attr('id');
		...
		$.ajax({
			url: 'https://spravka.000webhostapp.com/consultant/class/get_user_dialog.php',
			type: 'POST',
...
$('#dialog_search').click(function(){
	...
	if(for_date == "" || to_date == ""){
		...
		$.ajax({
			url: 'https://spravka.000webhostapp.com/consultant/class/get_dialog.php',
			type: 'POST',
...
$('.dell_black_list').click(function(){
	var ip = $(this).attr('id');
		...
		$.ajax({
			url: 'https://spravka.000webhostapp.com/consultant/class/dell_from_blacklist.php',
			type: 'POST',
			data: {user_ip: ip},
			cache: false,
			success: function(){
...
$('#add_new_group').click(function(){ // Добавляет новую группу
	...
	if(group_name != ""){
		...
		$.ajax({
			url: 'https://spravka.000webhostapp.com/consultant/class/add_group.php',
			type: 'POST',
...
function delOperator(id_operator){
    ...
    $.ajax({
        url: 'https://spravka.000webhostapp.com/consultant/class/del_operator.php',
		type: 'GET',
