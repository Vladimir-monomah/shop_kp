...
function controlOnNewMess(){
    ...
    //Отправляем запрос...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/get_operator_new_messages.php',
                    type: 'POST',
                    cache: false,
                    dataType: 'json',
                    error: function(){
                           ...
                           //console.log($('#'+user_id).length);
                            ...
                            for(var mess in messages[user_id]){ //Цикл сообщений для каждого пользователя
                                ...
                                if(user_id != ~~$('.active').attr('id') || $('#'+user_id+' .bar_guest_time').css('display') == 'none'){
                                    $('#'+user_id+' .bar_guest_status').css({'background-image': 'url(https://spravka.000webhostapp.com/consultant/images/guest_status_on.png)', 'display': 'block'});
...
function operatorSendMess(){
    ...
    if($.trim($('#admin_tablo_chat textarea').val()) != ""){
            ...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/add_operator_mess.php',
                    type: 'POST',
...
function addInBlackList(){
    ...
    var user_ip = $('#user_ip_'+id_user).val(); //Берем ip пользователя
            ...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/add_black_list.php',
                    type: 'POST',
...
function closeUserChat(){
    ...
    if(typeof arguments[0] == "object"){
        ...
        var user_id = arguments[0];
             ...
             $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/end_user_chat.php',
                    type: 'POST',
...
function rerout(){
    ...
    if(operator_id == null) return;
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/rerouting.php',
                    type: 'POST',
...
function setStatus(){
    ...
    $.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/operator.php',
            type: 'POST',
...
function loadUsers(){
    ...
    $.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/class/load_users.php',
            type: 'POST',
            cache: false,
            error: function(){
...
function selectUser(){
    ...
    if($('#'+user_id+' .bar_guest_time').css('display') != 'none'){
         $('#'+user_id+' .bar_guest_status').css({'background-image':'url(https://spravka.000webhostapp.com/consultant/images/guest_status_on.png)', 'display':'none'});
    }
...
function loadMessList(user_id){
    ...
    $.ajax({
            url: 'https://spravka.000webhostapp.com/consultant/class/load_mess_list.php',
            type: 'POST',
...
function delPhrases(){
    ...
    $(this).parent().remove();
        $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/del_phrases.php',
                    type: 'POST',
...
function setTyping(to){
    ...
    if($('.active').length == 1){
        ...
        if($('#'+user_id).data('typing') !== true || to == 0 && $('#'+user_id).data('typing') === true){//Не отмечено, отмечаем
            ...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/set_typing.php',
                    type: 'POST',
...
function getOperatorsMess(){
    ...
    if($('#list_operators_mess').data('last_message') === undefined){
        ...
        var last_message = $('#list_operators_mess').data('last_message');
            ...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/get_new_operators_chat_mess.php',
                    type: 'POST',
                    dataType: 'json',
...
function getOnlineOperators(isfor){
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/get_online_operators.php',
                    type: 'POST',
                    dataType: 'json',
                    cache: false,
                    error: function(){
...
function addOperatorsChat(){
    ...
    $('#text_operator_chat textarea').val("");
            ...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/add_operators_chat.php',
                    type: 'POST',
...
function getOnlineUsers(){
    ...
    if(onl_us != 0) return;
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/get_online_users.php',
                    type: 'POST',
                    dataType: 'json',
                    cache: false,
                    success: function(data){
                            ...
                            for(user in users){
                                ...
                                var user_tmp = '<div class="online_user" id="'+users[user].user_ip+'">'
                            							+'<div class="new_online_user">'
                            								...
                            								+'</div>'
                                                                                            +'<div class="bar_guest_country" style="background: url(https://spravka.000webhostapp.com/consultant/images/flags/'+users[user].country+'.png) 0px 0px no-repeat;"></div>'
                            							+'</div>'
...
function getUserInfo(from){
    ...
    //Иначе загружаем
        //alert(ip_user);
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/get_user_info.php',
                    type: 'POST',
                        ...
                        if(data){
                            ...
                            for(info in user_info['user_info']){
                               ...
                               switch(info){
                                   ...
                                   case "country":list_info += '<div class="user_info"><div class="user_info_left">Страна: </div><div class="user_info_right"><img src="https://spravka.000webhostapp.com/consultant/images/flags/'+user_info['user_info'].code+'.png" height="14" width="14" align="left" /> '+user_info['user_info'].country+'</div></div>';break;
                                   ...
                                   case "browser":if(user_info['user_info'].browser != null){ list_info += '<div class="user_info"><div class="user_info_left">Браузер: </div><div class="user_info_right"><img src="https://spravka.000webhostapp.com/consultant/images/browsers/'+getBrowserImg(user_info['user_info'].browser)+'" height="14" width="14" align="left" /> '+user_info['user_info'].browser+' '+user_info['user_info'].version+'</div></div>'};break;
                                   case "os":if(user_info['user_info'].os != null){ list_info += '<div class="user_info"><div class="user_info_left">ОС: </div><div class="user_info_right"><img src="https://spravka.000webhostapp.com/consultant/images/os/'+getOSImg(user_info['user_info'].os)+'" height="14" width="14" align="left" />'+user_info['user_info'].os+'</div></div>'};break;
                                   ...
                                   case "search_engine":list_info += '<div class="user_info"><div class="user_info_left">Поисковик: </div><div class="user_info_right"><img src="https://spravka.000webhostapp.com/consultant/images/finders/'+getFinderImg(user_info['user_info'].search_engine)+'" height="14" width="14" align="left" /> '+user_info['user_info'].search_engine+'</div></div>';break;
...
function inviteAutodialog(){
    if($('.online_active').length == 1){
        ...
        var message = $('#invite_autodialog_mess').val();
            ...
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/autodialog.php',
                    type: 'POST',
...
function linkInEnter() {
	...
	$.ajax({
        url: 'https://spravka.000webhostapp.com/consultant/class/link_in_url.php',
		type: 'POST',
...
function iOnline(){
            $.ajax({
                    url: 'https://spravka.000webhostapp.com/consultant/class/ionline.php',
                    type: 'POST',
                    cache: false
            });
}
...
function endUserChat(user_id){
    ...
    $('#'+user_id+' .bar_guest_status').css('background-image', 'url(https://spravka.000webhostapp.com/consultant/images/guest_status_off.png)');
...
function initAjaxLoad(){
	...
	var button = $('#uploadButton'), interval;
      ...
      $.ajax_upload(button, {
            action : 'https://spravka.000webhostapp.com/consultant/class/upload_file.php',
            name : 'upload_file',
			
			data: {id_user: id_user_file},
            onSubmit : function(file, ext) {
              
              $("img#load").attr("src", "https://spravka.000webhostapp.com/consultant/images/ajax-loader.gif");
