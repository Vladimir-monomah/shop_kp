...
if ($_SESSION['auth_admin'] == "yes_auth")
{
  ...
  $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> \ <a href='tovar.php' >Товары</a> \ <a>Изменение</a>";
...
if (isset($action))
{
   switch ($action) {
    ...
    {
       $msgerror = 'У вас нет прав на изменение данного товара!'; 
    }    
...
<!--Основной блок добавления товра -->
...
if ($row["type_tovara"] == "graphics") $type_graphics = "selected";
if ($row["type_tovara"] == "pc") $type_other = "selected";
...
<option '.$type_paper.' value="paper" >Бумага</option>
<option '.$type_paints.' value="paints" >Краски</option>
<option '.$type_graphics.' value="graphics" >Графика</option>
<option '.$type_other.' value="other" >Прочее</option>
