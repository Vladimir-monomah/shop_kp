...
if ($_SESSION['auth_admin'] == "yes_auth")
{
  ...
  $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> \ <a href='edit_administrators.php' >Изменение</a>";
...
<head>
	...
	<title>Панель для Администратора - Изменение Администратора</title>
</head>
<body>
...
<!--Основной блок изменение администратора -->
